...
import { FaPhone, FaEnvelope, FaMapMarkerAlt, FaClock, FaFacebook, FaInstagram, FaYoutube, FaTiktok, FaWhatsapp } from 'react-icons/fa';
          ...
          >
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center">
                ...
                <a href="https://wa.me/6281234567890" className="hover:underline">0812-3456-7890</a>
              </li>
            </ul>
          </motion.div>
