  ...
  return (
    <div className="bg-gray-50 min-h-screen flex flex-col">
      ...
      <main className="flex-grow pt-16 md:pt-20 lg:pt-24">
        ...
        {/* Main Content Area */}
        <div className={`container mx-auto px-4 py-8 ${isDesktop ? 'grid grid-cols-1 lg:grid-cols-3 gap-8' : 'space-y-8'}`}>
          ...
          <div className={isDesktop ? 'lg:col-span-2 space-y-8' : 'space-y-8'}>
            ...
            <div className="space-y-8">
              {/* Berita Kemenag */}
              <News category="kemenag" title="Berita Kemenag" isMobile={isMobile} />
