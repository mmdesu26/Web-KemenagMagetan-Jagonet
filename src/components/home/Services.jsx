    ...
    <section className="py-12 bg-white">
      <div className="container mx-auto px-4">
        <motion.div
          ...
          className="mb-8"
        >
          <h2 className="text-3xl font-bold text-center text-green-800 mb-4">Layanan Digital Kemenag</h2>
          <p className="text-center text-gray-600 max-w-2xl mx-auto">
            Akses berbagai layanan digital Kementerian Agama Kabupaten Magetan dengan mudah dan cepat.
          </p>
        </motion.div>
            ...
            >
              <div className="p-6">
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="font-bold text-lg mb-2 text-green-800">{service.name}</h3>
                    <a
                      href={service.url}
