...
const HeroSection = () => {
  const values = [
    { icon: <FaClock />, title: 'Cepat', desc: 'Pelayanan yang cepat dan tepat' },
    { icon: <FaLightbulb />, title: 'Inovatif', desc: 'Terus berinovasi dalam pelayanan' },
    { icon: <FaBalanceScale />, title: 'Netral', desc: 'Bersikap netral dan profesional' },
    { icon: <FaHeart />, title: 'Tulus', desc: 'Pelayanan dengan ketulusan hati' },
    { icon: <FaShieldAlt />, title: 'Amanah', desc: 'Menjunjung tinggi amanah' },
  ];
  ...
  return (
    <section className="relative bg-gradient-to-r from-green-700 to-green-600 text-white py-16">
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="text-2xl font-bold mb-6 text-center">Nilai-nilai CINTA</h2>
          <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
            {values.map((value, index) => (
              ...
              >
                <div className="text-3xl mb-2 flex justify-center">{value.icon}</div>
